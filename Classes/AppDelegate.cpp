...
bool AppDelegate::applicationDidFinishLaunching() {
	...
	if(!glview) {
        ...
        glview = GLViewImpl::createWithRect("Bakanoid", cocos2d::Rect(0, 0, designResolutionSize.width * ssize, designResolutionSize.height * ssize));
#else
        glview = GLViewImpl::create("Bakanoid");
#endif
